Source: https://www.odoo.com/documentation/19.0/applications/finance/accounting/taxes/cash_basis.html
...
Once this is done, go to Accounting ‣ Configuration ‣ Accounting: Taxes to configure your taxes. You can either Create a new tax or update an existing one by clicking on it.
...
| Customer journal (INV) | | | --- | --- | | Debit | Credit | | Receivable $1,150 | | | | Income $1,000 | | | Temporary tax account $150 |

When the payment is then received, it is registered as below :

| Bank journal (BANK) | | | --- | --- | | Debit | Credit | | Bank $1,150 | | | | Receivable $1,150 | 
...
| Tax Cash Basis Journal (Caba) | | | --- | --- | | Debit | Credit | | Income account $1,000 | | | Temporary tax account $150 | | | | Income account $1,000 | | | Tax Received $150 | 
...
Using a default Base Tax Received Account is recommended so your balance is at zero and your income account is not polluted by unnecessary accounting movements. To do so, go to Configuration ‣ Settings ‣ Taxes, and select a Base Tax Received Account under Cash Basis.
