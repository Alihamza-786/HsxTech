Source: https://www.odoo.com/documentation/19.0/applications/finance/accounting/taxes/vat_verification.html
...
Once the Verify VAT Numbers feature is enabled, if the contact’s Tax ID field is populated _and_ its country is different from your company’s country, Odoo displays an Intra-Community Valid checkbox. Odoo tests the VAT number through the VIES and automatically checks or unchecks the Intra-Community Valid checkbox depending on the validity of the VAT number.
