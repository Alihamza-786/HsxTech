Source: https://www.odoo.com/documentation/19.0/applications/finance/fiscal_localizations/romania.html
...
| Name | Technical name | Description | | --- | --- | --- | | Romania - Accounting | l10n_ro | Default fiscal localization package . | | Romanian SAF-T Export | l10n_ro_saft | Module to generate the D.406 declaration in the SAF-T format. | 

See also

Documentation on e-invoicing’s legality and compliance in Romania
...
To generate a file receivable by the Romanian Tax Agency, the chart of accounts must not deviate from an official chart of accounts, such as:
  ...
  * the chart of accounts for companies following IFRS (_PlanConturiIFRS_).
...
Download and install the _DUKIntegrator_ validation software found on the website of the Romanian Tax Agency.
