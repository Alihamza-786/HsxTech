Source: https://www.odoo.com/documentation/19.0/applications/finance/fiscal_localizations/peru.html
...
See also
  ...
  * Documentation on e-invoicing’s legality and compliance in Peru
...
Here are some terms that are essential on the Peruvian localization:
  ...
  * **OSE** : Electronic Service Operator, OSE SUNAT’s definition%20es%20qui%C3%A9n%20se%20encarga,otro%20documento%20que%20se%20emita).
...
| Credits | EUR | | --- | --- | | 1000 | 22 | | 5000 | 110 | | 10,000 | 220 | | 20,000 | 440 | 
...
Next, you need to retrieve the _client ID_ and _client secret_ from SUNAT. To do so, follow the manual de servicios web plataforma nueva GRE.
...
After configuring the Peruvian electronic invoicing flow, complete the following configurations for the **eCommerce** flow:
  ...
  * Delivery: For each shipping method, set the Provider field to Fixed Price. Then, set a Fixed Price amount greater than `0.00` (not zero), as the shipping method price is added to the invoice line.
