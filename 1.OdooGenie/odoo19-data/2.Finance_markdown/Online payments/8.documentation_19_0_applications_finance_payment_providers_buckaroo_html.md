Source: https://www.odoo.com/documentation/19.0/applications/finance/payment_providers/buckaroo.html
...
## Configuration on Buckaroo Plaza
  ...
  1. Log into Buckaroo Plaza, go to My Buckaroo ‣ Websites and select the Push settings tab.
...
## Configuration on Odoo
  ...
  1. Navigate to the payment provider Buckaroo and change its state to Enabled.
