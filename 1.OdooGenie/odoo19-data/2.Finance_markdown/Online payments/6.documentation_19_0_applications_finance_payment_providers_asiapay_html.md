Source: https://www.odoo.com/documentation/19.0/applications/finance/payment_providers/asiapay.html
...
## Configuration on Odoo
  ...
  2. In the Credentials tab, choose the Brand of your Asiapay account. Then fill in the Merchant ID and Secure Hash Secret, and the Currency in the Configuration tab with the values you saved at the step Configuration on AsiaPay Dashboard;

By default, the payment provider AsiaPay is configured to verify the secret hash with the hash function `SHA1`. If a different function is set on your account, activate the developer mode and set the same value to the field Secure Hash Function in the Credentials tab.
