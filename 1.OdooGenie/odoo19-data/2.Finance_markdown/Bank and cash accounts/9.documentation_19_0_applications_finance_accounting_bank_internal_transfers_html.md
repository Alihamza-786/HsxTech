Source: https://www.odoo.com/documentation/19.0/applications/finance/accounting/bank/internal_transfers.html
...
Take, for example, a transfer of $1000 from Bank A to Bank B:
  ...
  * Bank journal (Bank A)
| Account | Debit | Credit | | --- | --- | --- | | Bank A account | | $1,000 | | Internal transfer account | $1,000 | | 
  * Bank journal (Bank B)

| Account | Debit | Credit | | --- | --- | --- | | Bank B account | $1,000 | | | Internal transfer account | | $1,000 | 
