Source: https://www.odoo.com/documentation/19.0/applications/sales/point_of_sale/payment_methods/terminals/razorpay.html
...
Create a Razorpay account and set it up on their website.
...
You need the following credentials to set up the payment method in Odoo:
  ...
  * Razorpay device serial number, which can be found underneath the device or on Razorpay’s dashboard.

### Configure the payment method

  1. Activate the POS Razorpay module to enable the payment terminal.
...
Once the payment method is created, you can enable it for your POS. To do so, go to the POS’ settings and add the payment method under the Payment section.
