Source: https://www.odoo.com/documentation/19.0/applications/sales/point_of_sale/payment_methods/terminals/ingenico.html
...
Connecting an Ingenico payment terminal to Odoo is a feature that requires an IoT system. For more information on how to connect an IoT system to your database, please refer to the IoT documentation.
...
### Configure the Lane/Desk/Move 5000 terminals for Ingenico BENELUX
  ...
  2. Go to Kassa menu ‣ Settings Menu and enter the settings password (default: `2009`).
