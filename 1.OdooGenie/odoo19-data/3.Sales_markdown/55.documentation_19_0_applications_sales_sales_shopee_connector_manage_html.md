Source: https://www.odoo.com/documentation/19.0/applications/sales/sales/shopee_connector/manage.html
...
If you are starting a new Odoo database and your products are only on Shopee, you can import your Shopee product catalog into Odoo.
  ...
  2. **Import into Odoo:** Import the exported catalog into Odoo. During the import process, it is _crucial_ to map the Shopee SKU to the _Internal Reference_ field in Odoo. This field will serve as the link between your Shopee and Odoo products.
...
If you already have products in your Odoo database, you’ll need to map your Shopee listings to your existing Odoo products.
  ...
  1. **Export Shopee catalogs:** Use the _Mass Function_ drop-down to export the product catalog from Shopee (including Shopee SKUs) and export your product catalog from Odoo (including _Internal References_).
...
This feature is not available for NSSL, you have to manually create shipping label and tracking number via the logistics provider’s website/app. Check your region for list of supported logistics (e.g. Malaysia).
