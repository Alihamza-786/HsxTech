Source: https://www.odoo.com/documentation/19.0/applications/sales/sales/commissions.html
...
Performance can be measured in several ways in performance plans. These are configured in the Achievements tab of each plan.
  ...
  * MRR: the new _Monthly Recurring Revenue_ from subscription sales. this option is **only** available if the Subscriptions app is installed.
