Source: https://www.odoo.com/documentation/19.0/applications/general/integrations/mail_plugins/outlook.html
...
First, enable the _Mail Plugin_ feature in the database. Go to Settings ‣ General Settings ‣ Integrations, enable Mail Plugin, and Save the configuration.
...
Only a limited amount of **Company Insights** (_Lead Enrichment_) requests are available as a trial database. This feature requires prepaid credits.
...
By default, the Outlook Plugin can be opened from the _More actions_ menu. However, to save time, it’s possible to add it next to the other default actions.
