Source: https://www.odoo.com/documentation/19.0/applications/general/iot/devices/measurement_tool.html

# Connect a measurement tool

With Odoo’s IoT box, it is possible to connect measurement tools to the Odoo database for use in the _Quality app_ on a quality control point/quality check, or for use in a work center during the manufacturing process.
...
In the _Quality app_ , a device can be set up on a quality control point. To do that, navigate to Quality app ‣ Quality Control ‣ Control Points, and open the desired control point to which the measurement tool should be linked.
