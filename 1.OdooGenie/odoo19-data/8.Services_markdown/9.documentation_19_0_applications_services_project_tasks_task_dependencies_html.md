Source: https://www.odoo.com/documentation/19.0/applications/services/project/tasks/task_dependencies.html
...
To use task dependencies in a project, go to Project, click the __( vertical ellipsis) icon on one of your projects, and click on Settings. Click on the Settings. Click on the Settings tab, look for Tasks Management and make sure Task Dependencies is enabled.
...
To remove a task dependency, proceed as follows:
  ...
  * From the task form, go to the **Blocked by** tab and click the __( times) button.

  * From the Gantt view, click the red __( times) button that appears at the center of the arrow when you hover your mouse over it.