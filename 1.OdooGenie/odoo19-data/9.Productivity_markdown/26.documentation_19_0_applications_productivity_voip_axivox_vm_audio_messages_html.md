Source: https://www.odoo.com/documentation/19.0/applications/productivity/voip/axivox/vm_audio_messages.html
...
To start using voicemails and audio messages with Axivox, the global language should be set in the Axivox admin portal settings. To do that, navigate to manage.axivox.com. After logging into the portal, go to Settings ‣ Global language (e.g.: voicemail messages,…).
...
The next step is to set up the individual voicemail boxes on the Axivox administrative portal. To access the portal, visit manage.axivox.com and log in. Then, navigate to Voicemails, located in the menu on the left.
