Source: https://www.odoo.com/documentation/19.0/applications/productivity/voip/onsip.html
...
Odoo _VoIP_ can be set up to work together with OnSIP (Odoo Landing Page). OnSIP is a VoIP provider. An account is needed with OnSIP in order to use this service.
