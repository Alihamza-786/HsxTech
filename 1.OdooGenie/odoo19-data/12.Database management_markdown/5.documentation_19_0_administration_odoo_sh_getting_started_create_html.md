Source: https://www.odoo.com/documentation/19.0/administration/odoo_sh/getting_started/create.html

# Create your project

## Deploy your platform

Go to Odoo.sh and hit the _Deploy your platform_ button.

## Sign in with Github

Sign in with your Github account. If you do not have an account yet, hit the _Create an account_ link.

## Authorize Odoo.sh

Grant Odoo.sh the required accesses to your account by clicking the _Authorize_ button.
...
Enter your _subscription code_. This is also called _subscription referral_ , _contract number_ or _activation code_.
...
Once the backup imported, you can access the database using the _Connect_ button in the history of the branch.
