Source: https://www.odoo.com/documentation/19.0/administration/on_premise/packages.html
...
Make sure that the `sudo` command is available and well configured and, only then, execute the following command to install the PostgreSQL server:
...
Odoo 19 ‘rpm’ package supports Fedora 38.
...
On Windows 8 and later, a warning titled _Windows protected your PC_ may be displayed. Click **More Info** and then **Run anyway** to proceed.
