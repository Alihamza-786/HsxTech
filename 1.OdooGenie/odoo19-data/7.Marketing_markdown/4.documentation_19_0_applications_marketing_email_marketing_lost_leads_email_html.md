Source: https://www.odoo.com/documentation/19.0/applications/marketing/email_marketing/lost_leads_email.html
...
In order to create and deliver a lost leads reactivation email campaign, the _CRM_ and _Email Marketing_ applications **must** be installed and configured.
...
Now, with the domain section of the email campaign complete, create the body content of the email using any of the premade stylized templates, or choose between the Plain Text or Start From Scratch options for more granular control. For more information, refer to the _Email Marketing_ documentation on how to create an email.
...
For more information on _Lost Reasons_ , including the creation of them, refer to Lost opportunities.
