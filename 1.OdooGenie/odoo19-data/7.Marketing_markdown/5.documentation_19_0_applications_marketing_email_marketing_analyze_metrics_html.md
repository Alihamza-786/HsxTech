Source: https://www.odoo.com/documentation/19.0/applications/marketing/email_marketing/analyze_metrics.html
...
View Search, filter, and group records for more information about making custom groups and filters.
...
The following define possible reasons for a high bounce rate or low received rate:
  ...
  * Mailings sent using a _From_ email address that differs from the sender’s domain are likely to bounce with certain email providers due to failing DMARC authentication.
