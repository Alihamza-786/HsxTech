Source: https://www.odoo.com/documentation/19.0/applications/marketing/events/event_tracks.html
...
To access, modify, and/or create tracks for an event, first navigate to a preconfigured event, or create a new one from the _Events_ application.
