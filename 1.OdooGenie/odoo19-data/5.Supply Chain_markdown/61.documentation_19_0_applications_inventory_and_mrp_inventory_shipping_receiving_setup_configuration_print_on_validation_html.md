Source: https://www.odoo.com/documentation/19.0/applications/inventory_and_mrp/inventory/shipping_receiving/setup_configuration/print_on_validation.html
...
To automatically print a _carrier label_ with the recipient address, tracking number, and carrier details for specific third-party shipping carriers, complete the following setup:
  ...
  2. Connect a printer to Odoo’s _IoT_ app.
...
Refer to the Connect a printer documentation for details on connecting a printer to Odoo’s _IoT_ app. Upon completion, assign the carrier label to the printer, by navigating to IoT app ‣ Devices, and selecting the desired printer.
...
Next, complete the setup for the third-party shipping connector. After that, go to Inventory app ‣ Configuration ‣ Shipping Methods, and select the desired shipping method.
