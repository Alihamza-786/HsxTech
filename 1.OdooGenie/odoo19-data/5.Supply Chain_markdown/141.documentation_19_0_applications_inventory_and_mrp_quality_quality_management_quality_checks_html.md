Source: https://www.odoo.com/documentation/19.0/applications/inventory_and_mrp/quality/quality_management/quality_checks.html
...
Select a quality check type from the Type drop-down field:
  ...
  * Print label opens a pop-up from which labels can be printed. This step can be customized to provide instructions about where to add the labels on a product.
