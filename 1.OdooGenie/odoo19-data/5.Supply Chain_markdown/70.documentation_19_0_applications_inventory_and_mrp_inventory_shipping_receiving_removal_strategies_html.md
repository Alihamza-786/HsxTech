Source: https://www.odoo.com/documentation/19.0/applications/inventory_and_mrp/inventory/shipping_receiving/removal_strategies.html
...
| | FIFO | LIFO | FEFO | Closest Location | Least Packages | | --- | --- | --- | --- | --- | --- | | Based on | Incoming date | Incoming date | Removal date | Location sequence | Package quantity | | Selection order | First in | Last in | First to expire | Alphanumeric name of location | Quantity closest to fulfilling demand | 
...
| | FIFO | LIFO | FEFO | Closest Location | Least Packages | | --- | --- | --- | --- | --- | --- | | Required features | Lots & Serial Numbers | Lots & Serial Numbers | Lots & Serial Numbers, Expiration Date | Storage Locations, Multi-Step Routes | Packages | 
