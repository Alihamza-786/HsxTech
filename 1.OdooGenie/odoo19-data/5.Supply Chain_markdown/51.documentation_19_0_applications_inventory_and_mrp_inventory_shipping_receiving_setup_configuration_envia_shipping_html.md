Source: https://www.odoo.com/documentation/19.0/applications/inventory_and_mrp/inventory/shipping_receiving/setup_configuration/envia_shipping.html
...
| Country | Street | Street 2 | City | State_id | | --- | --- | --- | --- | --- | | Argentina | Street and number | Locality | City | Province | | Brazil | Exception | Neighborhood | City | State | | Chile | Street and number | City | Commune | Region | | Colombia | Street and number | Not needed | Municipality | Department | | Guatemala | Street and number | Neighborhood | City | State | | Mexico | Street and number | Neighborhood | City | State | | Uruguay | Street and number | Complementary info | Locality | State | 
