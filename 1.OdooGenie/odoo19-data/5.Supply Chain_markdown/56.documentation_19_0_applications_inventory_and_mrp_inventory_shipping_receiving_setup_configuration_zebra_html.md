Source: https://www.odoo.com/documentation/19.0/applications/inventory_and_mrp/inventory/shipping_receiving/setup_configuration/zebra.html
...
To begin customizing a Zebra label in Odoo, turn on developer mode, and on the main Odoo dashboard, type `Reports`. From the search results that appear in the resulting pop-up window, choose Settings / Technical / Reporting / Reports to open the Reports page.
...
Next, click the __ Qweb Views smart button, and choose the desired label view.
